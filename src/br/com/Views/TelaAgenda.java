...
public class TelaAgenda extends javax.swing.JFrame {
   ...
   Connection conexao = null;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String data_cliente = txtData.getText();
        String hora_cliente = txtHora.getText();
        String desc_cliente = txtDescricao.getText();


        AgendaDTO objAgendaDTO = new AgendaDTO();
        objAgendaDTO.setId(id);
        objAgendaDTO.setCliente(nome_cliente);
        objAgendaDTO.setData(data_cliente);
        objAgendaDTO.setHora(hora_cliente);
        objAgendaDTO.setDescricao(desc_cliente);
        

        AgendaDAO objAgendaDAO = new AgendaDAO();
        objAgendaDAO.pesquisar(objAgendaDTO);
